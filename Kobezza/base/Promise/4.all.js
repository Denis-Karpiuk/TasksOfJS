...
// Функция принимает иттерабл объект и если все промисы завершились успехом возвращает успешныый промис с массивом результатов, но если хотя бы один промис завершился бы с ошибкой, тогда вернется зареджекшеный промис
